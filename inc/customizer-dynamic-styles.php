...
function smile_web_get_dynamic_root_styles() {
	$link_default                  = sanitize_hex_color( get_theme_mod( 'link_default', '#55b561' ) );
	$link_hover                    = sanitize_hex_color( get_theme_mod( 'link_hover', '#1E3A5F' ) );
	$link_active                   = sanitize_hex_color( get_theme_mod( 'link_active', '#56b763' ) );
	$link_visited                  = sanitize_hex_color( get_theme_mod( 'link_visited', '#55b561' ) );
	...
	$cta_bg                        = sanitize_hex_color( get_theme_mod( 'cta_bg', '#c5e5c0' ) );
	...
	$accent_secondary              = sanitize_hex_color( get_theme_mod( 'accent-secondary', '#1e73be' ) );
	$accent_secondary_dark         = sanitize_hex_color( get_theme_mod( 'accent-secondary-dark', '#03204f' ) );
	$front_intro_overlay_color     = sanitize_hex_color( get_theme_mod( 'front_intro_overlay', '#002c54' ) );
	$front_intro_overlay_alpha     = floatval( get_theme_mod( 'front_intro_overlay_alpha', 0.6 ) );
	...
	$front_intro_heading           = sanitize_hex_color( get_theme_mod( 'front_intro_heading', '#c5e5c0' ) );
	...
	$page_intro_bg_color           = sanitize_hex_color( get_theme_mod( 'page_intro_bg', '#225274' ) );
	...
	$page_intro_heading            = sanitize_hex_color( get_theme_mod( 'page_intro_heading', '#c5e5c0' ) );
	$single_intro_bg_color         = sanitize_hex_color( get_theme_mod( 'single_intro_bg', '#225274' ) );
	...
	$single_intro_heading          = sanitize_hex_color( get_theme_mod( 'single_intro_heading', '#c5e5c0' ) );
	$bg_primary                    = sanitize_hex_color( get_theme_mod( 'bg_primary', '#f8f9fa' ) );
	$bg_secondary                  = sanitize_hex_color( get_theme_mod( 'bg_secondary', '#f5f3e5' ) );
	...
	$button_bg                     = sanitize_hex_color( get_theme_mod( 'button_bg', '#328701' ) );
	$button_bg_hover               = sanitize_hex_color( get_theme_mod( 'button_bg_hover', '#E8F2FF' ) );
	$button_border                 = sanitize_hex_color( get_theme_mod( 'button_border', '#0F7B5C' ) );
	$button_border_hover           = sanitize_hex_color( get_theme_mod( 'button_border_hover', '#1E3A5F' ) );
	...
	$form_error                    = sanitize_hex_color( get_theme_mod( 'form_error', '#E74C3C' ) );
	...
	$alert_error                   = sanitize_hex_color( get_theme_mod( 'alert_error', '#E74C3C' ) );
	$alert_warning                 = sanitize_hex_color( get_theme_mod( 'alert_warning', '#ffc107' ) );
	$alert_info                    = sanitize_hex_color( get_theme_mod( 'alert_info', '#1e73be' ) );
	...
	$topbar_social_icon            = sanitize_hex_color( get_theme_mod( 'topbar_social_icon', '#306a93' ) );
	$masthead_bg                   = sanitize_hex_color( get_theme_mod( 'masthead_bg', '#ffffff' ) );
	$masthead_submenu_bg           = sanitize_hex_color( get_theme_mod( 'masthead_submenu_bg', '#ededed' ) );
	$masthead_submenu_text         = sanitize_hex_color( get_theme_mod( 'masthead_submenu_text', '#306a93' ) );
	$masthead_text                 = sanitize_hex_color( get_theme_mod( 'masthead_text', '#E8F2FF' ) );
	$masthead_link                 = sanitize_hex_color( get_theme_mod( 'masthead_link', '#306a93' ) );
	$masthead_link_hover           = sanitize_hex_color( get_theme_mod( 'masthead_link_hover', '#307c03' ) );
	$masthead_scrolled_bg          = sanitize_hex_color( get_theme_mod( 'masthead_scrolled_bg', '#ffffff' ) );
	$footer_bg                     = sanitize_hex_color( get_theme_mod( 'footer_bg', '#08123d' ) );
	$footer_text                   = sanitize_hex_color( get_theme_mod( 'footer_text', '#FFFFFF' ) );
	$footer_link                   = sanitize_hex_color( get_theme_mod( 'footer_link_color', '#55b561' ) );
	$footer_link_hover             = sanitize_hex_color( get_theme_mod( 'footer_link_hover_color', '#ffffff' ) );
	...
	$footer_top_bg                 = sanitize_hex_color( get_theme_mod( 'footer_top_bg', '#ffffff' ) );
	$selection_bg                  = sanitize_hex_color( get_theme_mod( 'selection_bg', '#c1d6b3' ) );
	$icon_color                    = sanitize_hex_color( get_theme_mod( 'icon_color', '#001833' ) );
	$toc_link                      = sanitize_hex_color( get_theme_mod( 'toc_link', '#55b561' ) );
